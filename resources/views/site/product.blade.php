            ...
            <div class="row mt-20">
                ...
                <div class="col-md-7">
                    ...
                    <div class="single-product-details">
                        ...
                        @endforeach
                        <p class="product-price"> @php echo "The Price is = " @endphp ${{ $product->price }}</p>
                        ...
                        <form action="{{ route('site.add_to_cart') }}" method="POST">
                            ...
                            <div class="product-quantity">
                                ...
                                <div class="product-quantity-slider">
                                    <input id="product-quantity" type="number" name="quan" value="1"  min="1" max="{{ $product->quantity }}">
                                </div>
                            </div>
                                                ...
                                                <div class="media-body">
                                                    <div class="comment-info">
                                                        ...
                                                        <a class="comment-button" href="#!"><i
                                                                class="tf-ion-star"></i>{{ $item->star }}</a>
                                                    </div>
