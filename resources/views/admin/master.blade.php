                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                @foreach (auth()->user()->unreadnotifications as $notification)
                                    <a class="dropdown-item d-flex align-items-center" href="{{ route('readd', $notification->id) }}">
                                        <div class="mr-3">
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="{{  route('admin.notify.index') }}">Show All Alerts</a>
                            </div>
                        </li>
